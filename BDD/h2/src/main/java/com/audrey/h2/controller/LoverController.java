...
public class LoverController {
    ...
    @PostMapping("/lovers")
    public ResponseEntity<Lover> saveLover(@RequestBody Lover customer) {
        try {
            return new ResponseEntity<>(loverRepo.save(customer), HttpStatus.CREATED);
        } catch (Exception e) {
    ...
    @PutMapping("/lovers")
    public ResponseEntity<Lover> updateCustomer(@RequestBody Lover customer) {
        try {
            return new ResponseEntity<>(loverRepo.save(customer), HttpStatus.OK);
        } catch (Exception e) {
            return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
